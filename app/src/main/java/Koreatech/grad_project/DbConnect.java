...
/**
 회원가입 : add_audience.php                 input : 회원가입정보         return : id or -1
 로그인 : login.php                          input : number, name         return : id or -1
 ...
 전시관 전시물 : get_exhibit.php             input : count                result : { "1": [ { "name": "", "MAC": "", "space": "", "img": "" } ], "2": [..], "3": [..], "4": [..], "5": [..], "6": [..] }
 전시관 전시물 : get_exhibit_img.php             input : non                result : {"imgURL"... }
...
public class DbConnect extends AsyncTask<String, Void, String> {
    private static final String BASE_PATH = "http://35.230.121.30/android/";
    ...
    static final String GET_EXHIBIT = BASE_PATH + "get_exhibit.php";
    static final String GET_EXHIBIT_IMG = BASE_PATH + "get_exhibit_img.php";
    ...
    protected String doInBackground(String... params) {
        String serverURL = params.length>=1?params[0]:"";
        String id = params.length>=2?params[1]:"";
        String number = params.length>=3?params[2]:"";
        String name = params.length>=4?params[3]:"";
        String participation = params.length>=5?params[4]:"";
        String division = params.length>=6?params[5]:"";
        String temper = params.length>=7?params[6]:"";
        String phone = params.length>=8?params[7]:"";
        String destination = params.length>=9?params[8]:"";
        String count = params.length>=10?params[9]:"";
